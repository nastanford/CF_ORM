      ...
      <div class="col-md-8">
        <div class="card shadow">
          <div class="card-header bg-secondary text-white">
            <h3 class="mb-0"><i class="bi bi-person-plus"></i> Add New Artist</h3>
          </div>
          <div class="card-body">
            ...
            <form action="act_insert.cfm" method="post">
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="tel" class="form-control" id="fax" name="fax" maxlength="30">
                </div>
                <div class="col-md-6">
                  <label for="thepassword" class="form-label">Password</label>
                  <input type="password" class="form-control" id="thepassword" name="thepassword" maxlength="8" required>
                </div>
              </div>
          </div>
        </div>
          <div class="col-12 mt-4 pb-4 text-center">
            <button type="submit" name="submitArtist" class="btn btn-secondary">
              <i class="bi bi-save"></i> Add Artist
            </button>
          </div>
      </form>
      </div>
